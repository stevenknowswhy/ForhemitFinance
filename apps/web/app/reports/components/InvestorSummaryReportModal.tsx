...
/**
 * Investor Summary Report Modal
 * Comprehensive financial summary for investors
 */
...
interface InvestorSummaryReportModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function InvestorSummaryReportModal({
  open,
  onOpenChange,
}: InvestorSummaryReportModalProps) {
    ...
    return (
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Investor Summary</DialogTitle>
      ...
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto print:max-w-full print:max-h-none">
        ...
        <div className="space-y-8 print:space-y-6">
          ...
          <section className="border-b border-border pb-6">
            <h2 className="text-2xl font-bold text-foreground mb-4">Revenue & Growth</h2>
            ...
            <div>
              <h3 className="font-semibold mb-2">Top Revenue Categories</h3>
          ...
          <section className="border-b border-border pb-6">
            <h2 className="text-2xl font-bold text-foreground mb-4">Financial Metrics</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-muted rounded-lg">
          ...
          <section className="border-b border-border pb-6">
            <h2 className="text-2xl font-bold text-foreground mb-4">Cash Flow & Runway</h2>
