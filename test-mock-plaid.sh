...
if [ -f "apps/web/app/components/MockPlaidLink.tsx" ]; then
...
npx tsc --noEmit apps/web/app/components/MockPlaidLink.tsx 2>&1 | grep -v "investor_reports\|startup_metrics" || echo "✓ Mock Plaid files compile successfully"
